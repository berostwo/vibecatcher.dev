...
const openai_audit_1 = require("./openai-audit");
const github_service_1 = require("./github-service");
class AuditWorkerService {
    constructor() {
        this.firebaseService = new firebase_admin_1.FirebaseAdminService();
        this.openaiService = new openai_audit_1.OpenAIAuditService();
    ...
    async processAuditRequest(request) {
        ...
        try {
            ...
            // Clone repository
            const cloneResult = await this.githubService.cloneRepository(request.repositoryUrl, request.accessToken, request.branch);
            ...
            const auditResult = await this.openaiService.performSecurityAudit(request.repositoryName, cloneResult.files);
