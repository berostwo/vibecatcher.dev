...
import { OpenAIResponse, SecurityVulnerability } from '../types';
...
export class OpenAIAuditService {
  ...
  async performSecurityAudit(
    ...
    try {
      ...
      const auditResult: OpenAIResponse = JSON.parse(responseContent);
  ...
  private validateAuditResponse(response: any): void {
    ...
    response.vulnerabilities.forEach((vuln: any, index: number) => {
