...
export default function DashboardPage() {
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div>
        <h1 className="text-6xl font-bold font-headline uppercase italic -mb-6 text-primary/50">Dashboard</h1>
        <p className="text-muted-foreground mt-4">An overview of your account and security audits.</p>
      </div>
