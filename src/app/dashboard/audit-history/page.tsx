...
export default function AuditHistoryPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div>
        <h1 className="text-6xl font-bold font-headline uppercase italic -mb-6 text-primary/50">Audit History</h1>
        <p className="text-muted-foreground mt-4">
            Review and track the history of your previous audits.
        </p>
      </div>
