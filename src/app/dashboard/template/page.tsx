...
const AuditReportTemplate = ({ results }: { results: typeof mockAuditResult }) => {
...
export default function TemplatePage() {
    return (
        <DashboardPage>
            <DashboardPageHeader title="Template" description="This is an example of a security audit report." />
            <AuditReportTemplate results={mockAuditResult} />
        </DashboardPage>
    )
}
